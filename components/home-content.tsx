...
export default function HomeContent() {
  ...
  return (
    <div className="relative min-h-screen bg-black">
      ...
      <motion.div
        className="fixed inset-0 w-full h-[200vh] -top-[50vh]"
        style={{
          y: backgroundY,
          backgroundImage:
      ...
      >
        {/* Add a dark overlay to ensure no white shows through */}
      ...
      <div className="relative z-10 min-h-screen bg-transparent">
        ...
        >
          <nav className="container mx-auto px-4 py-3 flex justify-between items-center max-w-full">
            <Link href="/" className="flex items-center gap-2 text-lg font-semibold">
              <Logo className="h-10 w-10 filter-none" />
        ...
        <main className="relative">
          ...
          <section className="py-12 relative">
            ...
            >
              <h2
                className="text-5xl md:text-6xl lg:text-7xl font-bold text-center text-primary"
                style={{
                  WebkitTextStroke: "1px #f97316",
